...
export const translationsEN: Record<string, string> = {
  ...
  "pplg.sysop.title":         "Sistem Operation",
...
export const translationsID: Record<string, string> = {
  ...
  "stats.stack.sub":      "Ops · HTML · Figma · dan lainnya",
