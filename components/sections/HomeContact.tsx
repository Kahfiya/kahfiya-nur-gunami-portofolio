...
export default function HomeContact() {
  ...
  return (
    <section ref={ref} className="relative px-md tablet:px-2xl py-3xl max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <motion.div
        ...
        className="h-px bg-[var(--color-border)] mb-3xl origin-left"
      />
      ...
      <motion.div
        ...
        className="mb-2xl"
      >
        <p className="font-sans text-xs tracking-[0.2em] uppercase text-accent-500 mb-3">— {t("contact.subtitle")}</p>
        <div className="overflow-hidden">
          <motion.h2
            initial={{ y: "100%" }}
            animate={inView ? { y: 0 } : {}}
            transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
            className="font-serif font-bold leading-none text-[var(--color-text-primary)]"
        ...
        <div className="overflow-hidden">
          <motion.h2
            ...
            className="font-serif font-bold leading-none text-accent-500"
            style={{ fontSize: "clamp(2.5rem, 7vw, 6rem)" }}
          >
            {t("contact.heading2")}
          </motion.h2>
        ...
        <motion.p
          ...
          className="font-sans text-[var(--color-text-secondary)] mt-xl max-w-lg leading-relaxed"
      ...
      {/* Content grid */}
      <div className="grid grid-cols-1 tablet:grid-cols-2 gap-3xl">
        {/* Socials */}
        <div className="flex flex-col gap-xl">
          <p className="font-sans text-xs tracking-[0.2em] uppercase text-[var(--color-text-secondary)]">
