      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: showLabel
              ? "0 8px 28px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.25)"
...
function FloatingTechLogos() {
  return (
    <div
      className="absolute inset-0 overflow-visible hidden tablet:block"
      aria-hidden="true"
      style={{ zIndex: 1 }}
    >
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* ── Floating tech logos (desktop) ── */}
      <FloatingTechLogos />

      {/* ── Main content ── */}
      <motion.div
        className="relative z-10 w-full max-w-3xl mx-auto text-center flex flex-col items-center gap-5"
      >
        {/* Name */}
        <motion.h1
        ...
        >
          <a
            href="/work"
            className="px-6 py-3 rounded-full font-sans text-sm font-semibold transition-all duration-200 hover:scale-105 active:scale-95"
            style={{
              background: "#ffffff",
              color: "#171717",
            }}
